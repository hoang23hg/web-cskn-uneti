...
// icons - Module Chia Sẻ Và Kết Nối
import icoChiaSeVaKetNoi from '@/assets/Icons/icoChiaSeVaKetNoi.png'
import iconDodungcanhan from '@/assets/Icons/iconDodungcanhan.png'
import iconTailieuhoctap from '@/assets/Icons/iconTailieuhoctap.png'
import iconNhao from '@/assets/Icons/iconNhao.png'
import iconVieclam from '@/assets/Icons/iconVieclam.png'

// icons - Mudule Quản trị
...
export const homeMain = [
  ...
  },
  {
    ...
    desc: 'Chia sẻ, trao đổi, mua bán các loại tài liệu học tập; Cho thuê nhà ở, tìm kiếm nhà ở, tìm bạn ở ghép; Tìm kiếm trao đổi các loại đồ dùng cá nhân; Tìm kiếm việc làm, tuyển nhân sự',
    icon: icoChiaSeVaKetNoi,
    path: '/chia-se-va-ket-noi',
    moduleActive: true,
    roleActive: [ROLES.S0202],
  },
  {
    title: 'Quản trị Chia sẻ & Kết Nối',
    desc: 'Kiểm duyệt nội dung, xử lý báo cáo',
    icon: iconAdmin,
    path: '/quan-tri-chia-se-va-ket-noi',
    moduleActive: true,
    roleActive: [ROLES.S0202],
  },
]
...
export const homeChiaSeVaKetNoi = [
  {
    id: 1,
    title: 'Tài liệu học tập',
    desc: 'Chia sẻ, trao đổi, mua bán các loại tài liệu học tập.',
    path: '/tai-lieu-hoc-tap',
    thumbnail: iconTailieuhoctap,
    roleActive: [ROLES.S0202],
    moduleActive: true,
  },
  {
    id: 2,
    title: 'Nhà ở',
    desc: 'Cho thuê nhà ở, tìm kiếm nhà ở, tìm bạn ở ghép.',
    path: '/nha-o',
    thumbnail: iconNhao,
    roleActive: [ROLES.S0202],
    moduleActive: true,
  },
  {
    ...
    desc: 'Tìm kiếm trao đổi các loại đồ dùng cá nhân',
    path: '/do-dung-ca-nhan',
    thumbnail: iconDodungcanhan,
    roleActive: [ROLES.S0202],
    moduleActive: true,
  },
  {
    id: 4,
    title: 'Việc làm',
    desc: 'Tìm kiếm việc làm, tuyển nhân sự',
    path: '/viec-lam',
    thumbnail: iconVieclam,
    roleActive: [ROLES.S0202],
    moduleActive: true,
  },
]
