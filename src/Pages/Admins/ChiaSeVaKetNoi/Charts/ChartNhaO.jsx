        ...
        >
          <Chart
            ...
            options={{
              ...
              labels: ['Bài cho thuê trọ', 'Bài tìm trọ', 'Chờ phê duyệt'],
              fill: {
                colors: ['#1a5cff', '#46c93a', '#ff4757'],
          ...
          >
            <div className={bem.em('details', 'item')}>
              ...
              />
              <span>Bài đăng cho thuê trọ</span>
            </div>
            <div className={bem.em('details', 'item')}>
              <div
                className={bem.em('details', 'item-color')}
